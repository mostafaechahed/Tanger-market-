...
<input type="file" name="img" value="<?php echo $data ['PHOTO']?>"   class="zonetext" required><br>
...
if(isset($_POST['btmod']))
{
    ...
    $reqUp="UPDATE automobile SET MARQUE='$marque',PRXLOCA='$prixloc',PHOTO='$target' WHERE IMM='$modifie'";
